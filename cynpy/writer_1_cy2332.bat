...
REM SET HEXFILE=..\fw\cy2311r3\Objects\cy2311r3_x004.hex
    SET HEXFILE=z:\RD\Project\CAN1112\Ray\fw\cy2332r0_20181024_033.hex
    ECHO =%HEXFILE%=
...
REM ===============================================================================
    ...
    python %PROG% 1 w e7=00 bc=08 e4=02 e5=3e af=00 b0=00 be=07
    python %PROG% 1 trim
...
REM python %PROG% prog_asc 1 910 CAN1112A28L_BIN1
    python %PROG% prog_str 1 930 PY188_%DATE:~2,2%%DATE:~5,2%%DATE:~8,2%%TIME:~0,2%%TIME:~3,2%
